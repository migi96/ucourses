        ...
        myChild: Stack(
          children: [
            const ImagePositions(
              imagePath: '${ImageAssets.backgroundImagePath}t_seven.png',
              opacity: 0.07,
            ),
            Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      _buildTabButton(
                          "all", Icons.menu_book, AppTexts.allCourses),
                      _buildTabButton(
                          "draft", Icons.drafts, AppTexts.newerCourses),
                      _buildTabButton(
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              ...
                              style:
                                  Styles.style18.copyWith(color: Colors.white),
                            ),
                    ...
                    builder: (context, state) {
                      if (state is AdminCoursesLoaded) {
                        return CourseGrid(
                          ...
                          isDeletedTab: _selectedTab ==
                              "deleted", // Pass isDeletedTab here
                        );
